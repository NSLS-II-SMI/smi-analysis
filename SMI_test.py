...
if __name__ == '__main__':
    ...
    geometry, sdd, wav, alphai, center, bs_pos, detector = 'Transmission', 273.9, 1E-9 * (12.39842/2.4), np.deg2rad(0.0), [96., 1475-89.5], [7, 1330], 'Pilatus300kw'
    ...
    print(dat[0][0])
    SMI.stitching_data(path, [dat[0][0]])
